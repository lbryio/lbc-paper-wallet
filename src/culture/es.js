(function (translator) {
	translator.translations["es"] = {
		...
		"paperlabelbitcoinaddress": "Dirección LBRY Credits:",
		...
		"brainalertpassphrasewarning": "Aviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus LBRY Credits.",
		...
		"vanityalertinvalidinputcannotmultiple": "Entrada no válida. No se puede multiplicar dos claves públicas. Seleccione 'Añadir' para agregar dos claves públicas para obtener una dirección LBRY Credits.",
		...
		"tagline": "Generador de carteras LBRY Credits de código abierto en lado de cliente con Javascript",
		"generatelabelbitcoinaddress": "Generando dirección LBRY Credits...",
		...
		"singlelabelbitcoinaddress": "Dirección LBRY Credits",
		"singlelabelprivatekey": "Clave privada (formato para importar):",
		"singletip1": "<b>A LBRY Credits wallet</b> is as simple as a single pairing of a LBRY Credits address with its corresponding LBRY Credits private key. Such a wallet has been generated for you in your web browser and is displayed above.", //TODO: please translate
		"singletip2": "<b>To safeguard this wallet</b> you must print or otherwise record the LBRY Credits address and private key. It is important to make a backup copy of the private key and store it in a safe location. This site does not have knowledge of your private key. If you leave/refresh the site or press the \"Generate New Address\" button then a new private key will be generated and the previously displayed private key will not be retrievable.\tYour LBRY Credits private key should be kept a secret. Whomever you share the private key with has access to spend all the LBRY Credits associated with that address. If you print your wallet then store it in a zip lock bag to keep it safe from water. Treat a paper wallet like cash.", //TODO: please translate
		"singletip3": "<b>Add funds</b> to this wallet by instructing others to send LBRY Credits to your LBRY Credits address.", //TODO: please translate
		"singletip4": "<b>Check your balance</b> by going to <a target=\"_blank\" href=\"https://explorer.lbry.io\">explorer.lbry.io</a> and entering your LBRY Credits address.", //TODO: please translate
		"singletip5": "<b>Spend your LBRY Credits</b> by going to <a target=\"_blank\" href=\"https://lbry.io\">lbry.io</a> and sweep the full balance of your private key into your account using their app. You can also spend your funds by downloading one of the popular LBRY Credits p2p clients and importing your private key to the p2p client wallet. Keep in mind when you import your single key to a LBRY Credits p2p client and spend funds your key will be bundled with other private keys in the p2p client wallet. When you perform a transaction your change will be sent to another LBRY Credits address within the p2p client wallet. You must then backup the p2p client wallet and keep it safe as your remaining LBRY Credits will be stored there. Satoshi advised that one should never delete a wallet.", //TODO: please translate
		...
		"bulklabelq1": "¿Por qué debo usar \"Direcciones en masa\" para aceptar LBRY Credits en mi web?",
		"bulka1": "La forma tradicional de aceptar LBRY Credits en tu web requiere tener instalado el cliente oficial de LBRY Credits (\"lbrycrdd\"). Sin embargo muchos servicios de hosting no permiten instalar dicho cliente. Además, ejecutar el cliente en tu servidor supone que las claves privadas están también en el servidor y podrían ser comprometidas en caso de intrusión. Al usar este mecanismo, puedes subir al servidor sólo las dirección de LBRY Credits y no las claves privadas. De esta forma no te tienes que preocupar de que alguien robe la cartera si se cuelan en el servidor.",
		"bulklabelq2": "¿Cómo uso \"Direcciones en masa\" para aceptar LBRY Credits en mi web?",
		...
		"bulklabela2li3": "Ofrece una alternativa en el carro de la compra de tu web para que los clientes paguen con LBRY Credits. Cuando el cliente elija pagar con LBRY Credits, les muestras una de las direcciones de la base de datos como su \"dirección de pago\" y guardas esto junto con el pedido.",
		"bulklabela2li4": "Ahora te hace falta recibir una notificación del pago. Busca en google \"notificación de pagos LBRY Credits\" (o \"LBRY Credits payment notification\" en inglés) y suscríbete a alguno de los servicios que aparezcan. Hay varios de ellos, que te pueden notificar vía Web services, API, SMS, email, etc. Una vez te llegue la notificación, lo cual puede ser automatizado, entonces ya puedes procesar el pedido. Para comprobar a mano si has recibido un pago, puedes usar Block Explorer: reemplaza DIRECCION a continuación por la dirección que estés comprobando. La transacción puede tardar entre 10 minutos y una hora en ser confirmada. <br />https://explorer.lbry.io/address/DIRECCION<br /><br />Puedes ver las transacciones sin confirmar en: https://explorer.lbry.io/ <br />Las transacciones sin confirmar suelen aparecer ahí en unos 30 segundos.",
		"bulklabela2li5": "Las LBRY Credits que recibas se almacenarán de forma segura en la cadena de bloques. Usa la cartera original que generaste en el paso 1 para usarlas.",
		...
		"brainlabelbitcoinaddress": "Dirección LBRY Credits:",
		...
		"vanitylabelbitcoinaddress": "Dirección LBRY Credits personalizada:",
		...
		"detaillabelnote2": "LBRY Credits v0.6+ almacena las claves públicas comprimidas. El cliente también soporta importar/exportar claves privadas usando importprivkey/dumpprivkey. El formato de las claves privadas exportadas depende de si la dirección se generó en una cartera antigua o nueva.",
		"detaillabelbitcoinaddress": "Dirección LBRY Credits:",
		"detaillabelbitcoinaddresscomp": "Dirección LBRY Credits (comprimida):",
