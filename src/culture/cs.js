(function (translator) {
	translator.translations["cs"] = {
		...
		"bulklabelq1": "Proč bych měl používat Hromadnou peněženku pro příjem LBRY Credits na mé stránce?",
		"bulka1": "Tradiční způsob jak přijímat LBRY Credits na vaší webové stránce vyžaduje instalaci oficiálního LBRY Credits klienta (\"lbrycrdd\"). Mnoho webhostingových společností neumožňuje tuto instalaci provést. Také běh LBRY Credits démona na webovém serveru znamená, že soukromé klíče jsou uloženy na serveru a mohou být ukradeny. Pokud použijete Hromadnou peněženku, tak stačí na server nahrát pouze veřejnou LBRY Credits adresu a ne soukromé klíče. Poté se nemusíte bát, že vaše LBRY Credits budou ukradeny v případě napadení serveru.",
		"bulklabelq2": "Jakým způsobem mohou přijímat LBRY Credits na mé stránce pomocí Hromadné peněženky?",
		...
		"bulklabela2li3": "Umožněte na vaší stránce platbu pomocí LBRY Credits. Stačí vždy zobrazit jednu z vygenerovaných adres a uložit si ji u objednávky.",
		"bulklabela2li4": "Nyní je již pouze potřeba zařídit notifikace o příchozí transakci. Zadejte do Google \"LBRY Credits payment notification\" a využijte jednu z existujících služeb. Existuje jich několik a podporují např. Web Services, API, SMS, Email, apod. Notifikaci můžete zpracovat automaticky. Pro ruční kontrolu, zda peníze přišly, stačí použít LBRY Block Explorer. Nahraďte SEMPATŘÍADRESA LBRY Credits adresou, kterou chcete zkontrolovat. Potvrzení transkace může trvat od 10 minut do jedné hodiny.<br />https://explorer.lbry.io/address/SEMPATŘÍADRESA<br /><br />Nepotvrzené tansakce je možné zkontrolovat na: <a target=\"_blank\" href=\"https://explorer.lbry.io\">explorer.lbry.io</a> <br />Většinou se zde zobrazí do 30 sekund.",
		"bulklabela2li5": "LBRY Credits budou bezpečně převedeny v řetězci bloků. Pro spotřebování stačí kdykoliv naimportovat soubor vygenerovaný v prvním kroku.",
