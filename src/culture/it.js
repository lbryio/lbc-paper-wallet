(function (translator) {
	translator.translations["it"] = {
		...
		"brainalertpassphrasewarning": "Attenzione: La scelta di una passphrase robusta è importante per evitare attacchi brute force in grado di indovinare la tua passphrase e rubare i tuoi LBRY Credits",
		...
		"singleprint": "Stampa",
		"singlelabelbitcoinaddress": "Indirizzo LBRY Credits:",
		...
		"bulklabelq1": "Perché dovrei usare tanti portafogli per accettare LBRY Credits sul mio sito web?",
		"bulka1": "Il tradizionale approcio per accettare i LBRY Credits è quello di installare il demone ufficiale LBRY Credits (\"lbrycrdd\"). Molti pacchetti di hosting web non supportano l'installazione di tale demone. Inoltre tenere in esecuzione il demone richiede che la chiave privata del portafogli sia custodita sul server, se questo viene violato tramite hacking puoi perdere tutti i LBRY Credits. Usando portafogli multipli puoi caricare sul server solo l'indirizzo per il versamento e non la chiave privata. Quindi non devi preoccuparti del tuo portafogli nel caso in cui il server venga violato con un attacco di hacking.",
		"bulklabelq2": "Come utilizzo tutti questi portafogli per accettare LBRY Credits sul mio sito web?",
		"bulklabela2li1": "Usa la funzione \"Portafogli multipli\" per generare una grande quantità di indirizzi LBRY Credits (10,000+). Copia e incolla la lista generata in formato CSV (campi separati da virgola) su un file, al sicuro nel tuo computer. Fai una copia di backup di questo file e mettilo un posto sicuro.",
		"bulklabela2li2": "Importa gli indirizzi LBRY Credits in una tabella del database sul tuo web server. (Non importare i portafogli/chiavi private sul web server, altrimenti corri il rischio che rubino i tuoi LBRY Credits con l'hacking. Usa gli indirizzi LBRY Credits così come verranno mostrati ai tuoi clienti.)",
		"bulklabela2li3": "Fornisci una opzione nel carrello del tuo sito web per pagare in LBRY Credits. Quando il cliente sceglie di pagare in LBRY Credits, gli mostrerai un indirizzo dal tuo database come \"indirizzo di pagamento\" e conserverai questo stesso indirizzo insieme ai dati dell'ordine.",
		"bulklabela2li4": "Ora hai bisogno di notificare l'arrivo del pagamento. Cerca su Google \"notifiche pagamento LBRY Credits\" ed iscriviti ad almeno un servizio di notifica. Esistono diversi servizi che possono notificare in vari modi come Web Services, API, SMS, Email, etc. Una volta ricevuta la notifica, la quale può essere automatizzata con la programmazione, puoi processare l'ordine del cliente. Per verificare manualmente se l'ordine è davvero arrivato puoi usare un LBRY Block Explorer. Sostituisci INDIRIZZODACONTROLLARE con l'indirizzo LBRY Credits da controllare. Possono volerci dai 10 fino a 60 minuti per fare in modo che una transazione venga confermata.<br>https://explorer.lbry.io/address/INDIRIZZODACONTROLLARE<br><br>Le transazioni non confermate possono essere visionate su: <a target=\"_blank\" href=\"https://explorer.lbry.io\">explorer.lbry.io</a> <br>Dovresti vedere la transazione entro 30 secondi.",
		"bulklabela2li5": "In questo modo i LBRY Credits transiteranno nella blockchain in tutta sicurezza. Usa il portafogli creato nel Passo 1 per spendere i LBRY Credits.",
		...
		"brainlabelbitcoinaddress": "Indirizzo LBRY Credits:",
